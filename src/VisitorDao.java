...
public class VisitorDao {
    ...
    private static VisitorDao dao = new VisitorDao();
    private VisitorDao(){
    ...
    public  int insertVisitorDetails(String visitor_name, String visitor_gender, String visitor_category, float visitor_time){
    ...
    public  int getVisitorId(int ticketNumber){
    ...
    public  void insertVisitorToTicketRelation(int visitor_id, int ticket_id){
    ...
    public  void InsertVisitorToRideDetails(int visitor_id, int ride_id, float visitor_time, int visitor_paid_amount){
